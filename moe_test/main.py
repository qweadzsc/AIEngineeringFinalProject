...
def run_bm_generation(model, input_ids, max_new_tokens):
    """Run generation using the naive generation path."""
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help="Total drafted tokens budget passed to EaModel.from_pretrained(...). Use 128 for the bs128 real-generation setting. (default: 64)",
    )
    parser.add_argument(
