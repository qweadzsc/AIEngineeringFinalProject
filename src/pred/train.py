...
if __name__ == "__main__":
    ...
    weight_list = [1536, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1536,
                   1024, 1024, 1024, 1024, 1536, 1024, 1024, 1024, 1408, 1280, 1536, 1536, 1536,
                   1536, 1792, 1792, 1536, 1536, 1792]
    models = [Predictor(4096, 14336, weight_list[i]) for i in range(32)]
    ...
    torch.save(models, "/share/public/zhouyongkang/projects/sc/data/preds/pred.pt")
